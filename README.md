...
__Pose homogenization (updated)__ Running [U-2-Net masks/silhouettes separation](https://github.com/NathanUA/U-2-Net), followed by comparing the histograms of two mask image halves (split by a vertical centerline) helped me to get rid of some really asymmetric images.
...
# and asymmetric samples to check the metric value.
